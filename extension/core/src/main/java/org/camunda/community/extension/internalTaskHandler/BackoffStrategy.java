 ...
 *
 * <p>Note: Since an implementation of this interface may be executed by multiple threads, it is
 * recommended to implement the custom backoff strategy in a thread-safe manner.
 */
public interface BackoffStrategy {

  /**
   * Reconfigures the back off strategy based on the fetched external tasks and is invoked before
   * {@link #calculateBackoffTime}.
   *
   ...
   */
  void reconfigure(List<LockedExternalTask> externalTasks);
